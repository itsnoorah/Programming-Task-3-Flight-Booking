...
public class Manager {
    ...
    List<Flight> flights; // list of object type "Flights"
    					  // <> catches type-related errors in compile time
    List<Ticket> tickets; // list of objects type "Ticket"

    public Manager() {
        flights = new ArrayList<Flight>(); // Create an ArrayList of object type Flights
        tickets = new ArrayList<Ticket>(); // Resizable array (found in the java.util package)
    ...
    public void createFlights() {
        ...
        Scanner scan1 = new Scanner(System.in); // takes in integers 
        Scanner scan2 = new Scanner(System.in); // takes in Strings
        Scanner scan3 = new Scanner(System.in); // takes in doubles 
